...
def create_feature_documentation(X: pd.DataFrame):
    ...
    # save documentation
    doc_path = '/home/yeblad/Desktop/New_WR_analysis/outputs/feature_documentation.md'
...
def main():
    ...
    X.to_parquet('/home/yeblad/Desktop/New_WR_analysis/outputs/features_X.parquet', index=False)
    y.to_frame('target').to_parquet('/home/yeblad/Desktop/New_WR_analysis/outputs/target_y.parquet', index=False)
    
    print(f"\nfeatures saved to: /home/yeblad/Desktop/New_WR_analysis/outputs/features_X.parquet")
    print(f"target saved to: /home/yeblad/Desktop/New_WR_analysis/outputs/target_y.parquet")
